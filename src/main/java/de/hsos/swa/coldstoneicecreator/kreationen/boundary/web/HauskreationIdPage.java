...
public class HauskreationIdPage {
    ...
    static class Templates {
        ...
        static native TemplateInstance hauskreationEinzeln(HauskreationDTO hauskreationDTO);
    ...
    public TemplateInstance get(@NotNull @PathParam("id") Long id) {
        ...
        if(hauskreation != null) {
            ...
            return Templates.hauskreationEinzeln(hauskreationDTO);
        }
        return Templates.error(Response.Status.BAD_REQUEST.getStatusCode(), "Hauskreation nicht gefunden");
    }
